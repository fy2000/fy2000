...
if __name__ == '__main__':
    file_path = r'F:\0001_workspace\01_待处理的问题\A-路网通\00_待解码数据\0000_TEMP\本周未完成工作\辽宁\网格16\2402451820210824101043MS1.l5g'
    ...
    with open(r'F:\0001_workspace\01_待处理的问题\A-路网通\00_待解码数据\0000_TEMP\本周未完成工作\辽宁\网格16\2402451820210824101043MS1.csv', 'a', newline='') as r:
        writer = csv.writer(r)
        sumtime = sum(ttime)
        sumsize = sum(tsize)
